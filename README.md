...
What happens on the weekend in twenty and twenty six, when walking along the beach you see a distant camera flash? You remember the time you were in a stadium trying to find a friend, but the cell network was jammed by eighty thousand people. Flash you cell phone light to locate them, and then wish you time to build an app that transmitted and recieved messages with morse code. This weekend we go down the rabbit hole of sensors with Claude taking the time to build.
